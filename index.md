...
<section class="section-block section-intro-left">
  ...
  <div class="card-grid">
    <article class="card">
      <h3>No Emergency Response</h3>
      <p>TechNerd Consulting does not currently provide emergency incident response or 24/7 monitoring services.</p>
    </article>

    <article class="card">
      <h3>No Compliance Certification</h3>
      <p>Consulting guidance does not replace formal compliance auditing, legal review, or certification services.</p>
    </article>

    <article class="card">
      <h3>No Fear-Based Security</h3>
      <p>The focus is practical, sustainable improvement rather than panic-driven security messaging.</p>
    </article>
  </div>
</section>
